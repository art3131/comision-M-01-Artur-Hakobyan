        ...
        <div className="px-6 md:px-[200px] mt-8">
            ...
            <div className="flex flex-col">
                <div className="flex items-center space-x-4 md:space-x-8 ">
                    <input required value={cat} onChange={(e)=>setCat(e.target.value)} type="text" className="px-4 py-2 outline-none" placeholder="Enter Post Category" />
            ...
            <textarea cols={30} rows={15} className=" rounded-xl px-4 py-2 outline-none bg-grey" placeholder="Enter post description"/>
